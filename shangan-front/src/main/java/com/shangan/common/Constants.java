...
public class Constants {
     ...
     */
    public final static int SHOPPING_CART_ITEM_LIMIT_NUMBER = 5000;
     ...
     * 购物车分页的默认条数(每页5条)
     */
    public final static int SHOPPING_CART_PAGE_LIMIT = 5000;

    /**
     * 购物车分页的默认条数(每页10条)
     */
    public final static int USER_ADDRESS_PAGE_LIMIT = 10000;
     ...
     * 简介
     */
    public final static String USER_INTRO = "上岸商城的尊贵用户";

    /**
     * 用户登录结果返回的长度限制
     */
    public static final double TOKEN_RESULT_LENGTH = 50;
}
